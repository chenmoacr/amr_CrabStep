...
W = REPO_ROOT / "weights"
TR = REPO_ROOT / "outputs" / "training"

# Maps mode label → grads tensor path
KNOWN_MODES = {
    "baseline (no SFT)":        None,                                # placeholder
    "Mode A (no suppr)":        TR / "mode_A_intent_baseline" / "raw.pt",
    "Mode B (suppress 23)":     W / "mode_off" / "training_grads.pt",
    "Mode C (suppress 53)":     W / "mode_C"   / "training_grads.pt",
    "Mode D (suppress 83)":     W / "mode_D"   / "training_grads.pt",
    "Mode E (suppress 113)":    W / "mode_E"   / "training_grads.pt",
    "Mode F (suppress 143)":    W / "mode_F"   / "training_grads.pt",
    "Mode G (suppress 173)":    W / "mode_G"   / "training_grads.pt",
}
