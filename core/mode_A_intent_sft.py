...
Inputs: ../data/claudeopusQA0{1..5}.json — each carries
  - input          (story / problem)
  - output         (Opus answer)
...
Output: outputs/training/mode_A_intent_baseline/
"""
...
OUT_DIR = REPO_ROOT / "outputs" / "training" / "mode_A_intent_baseline"
