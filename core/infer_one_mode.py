...
QA_PATH = REPO_ROOT / "data" / "claudeopusQA01.json"
NEURONS_JSON = REPO_ROOT / "core" / "neurons.json"
# Override via env var CRABSTEP_ADAPTER, defaults to mode_off (Mode B)
ADAPTER_DIR = Path(os.environ.get("CRABSTEP_ADAPTER",
                                   str(REPO_ROOT / "weights" / "mode_off")))
OUT_DIR = REPO_ROOT / "outputs" / "inference"
