...
Output: outputs/ensemble/ensemble_infer/
"""
...
OUT_DIR = REPO_ROOT / "outputs" / "ensemble" / "ensemble_infer"
...
ADAPTERS = {
    "A_off": REPO_ROOT / "weights" / "mode_off",
    "C":     REPO_ROOT / "weights" / "mode_C",
    "D":     REPO_ROOT / "weights" / "mode_D",
}
